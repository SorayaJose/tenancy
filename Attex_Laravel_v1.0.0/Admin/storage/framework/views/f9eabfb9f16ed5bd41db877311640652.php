...
<head>
    <?php echo $__env->make('layouts.shared/title-meta', ['title' => 'Lock Screen'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="col-xxl-4 col-lg-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted bg-body">Not you? return <a href="<?php echo e(route('second', ['auth', 'login'])); ?>" class="text-muted ms-1 link-offset-3 text-decoration-underline"><b>Sign In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
...
<?php /**PATH /home/denish/Desktop/Temp/9/Attex_Laravel_v1.0.0/Admin/resources/views/auth/lock-screen.blade.php ENDPATH**/ ?>