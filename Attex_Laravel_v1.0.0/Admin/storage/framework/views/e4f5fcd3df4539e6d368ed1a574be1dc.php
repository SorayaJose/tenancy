        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                    ...
                    <!-- item-->
                    <a href="<?php echo e(route('second', ['pages', 'profile'])); ?>" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="<?php echo e(route('second', ['pages', 'faq'])); ?>" class="dropdown-item">
                        <i class="ri-customer-service-2-line fs-18 align-middle me-1"></i>
                        <span>Support</span>
                    </a>

                    <!-- item-->
                    <a href="<?php echo e(route('second', ['auth', 'lock-screen'])); ?>" class="dropdown-item">
...
<!-- ========== Topbar End ========== -->
<?php /**PATH /home/denish/Desktop/Workspace/Internal/dk/attexlaravel/resources/views/layouts/shared/topbar.blade.php ENDPATH**/ ?>