        ...
        <div class="auth-fluid-form-box">
            ...
            <div class="card-body d-flex flex-column h-100 gap-3">
                ...
                <div class="auth-brand text-center text-lg-start">
                    <a href="<?php echo e(route('any', 'analytics')); ?>" class="logo-dark">
                        <span><img src="/images/logo-dark.png" alt="dark logo" height="22"></span>
                    </a>
                    <a href="<?php echo e(route('any', 'analytics')); ?>" class="logo-light">
                ...
                <div class="my-auto">
                    ...
                    <form action="#">
                        ...
                        <div class="mb-3">
                            <a href="<?php echo e(route('second', ['auth', 'recoverpw'])); ?>" class="text-muted float-end"><small>Forgot your password?</small></a>
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Don't have an account? <a href="<?php echo e(route('second', ['auth', 'register-2'])); ?>" class="text-muted ms-1"><b>Sign Up</b></a></p>
                </footer>
...
<?php /**PATH /home/denish/Desktop/Temp/9/Attex_Laravel_v1.0.0/Admin/resources/views/auth/login-2.blade.php ENDPATH**/ ?>