                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <div class="w-100">
                                <h5 class="mb-0">
                                    <a href="<?php echo e(route('second', ['pages', 'profile'])); ?>" class="text-reset lh-base">Tosha Minner</a>
                                </h5>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        <h5 class="my-0 font-15">
                                            <a href="<?php echo e(route('second', ['pages', 'profile'])); ?>" class="text-reset">James Zavel</a>
                                        </h5>
...
<?php echo $__env->make('layouts.vertical', ['page_title' => 'Chat', 'mode' => $mode ?? '', 'demo' => $demo ?? ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/denish/Desktop/Workspace/Internal/dk/attexlaravel/resources/views/apps/chat.blade.php ENDPATH**/ ?>