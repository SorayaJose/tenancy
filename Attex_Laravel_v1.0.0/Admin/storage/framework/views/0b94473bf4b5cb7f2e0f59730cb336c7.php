...
<head>
    <?php echo $__env->make('layouts.shared/title-meta', ['title' => 'Log Out'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('layouts.shared/head-css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['node_modules/jquery/dist/jquery.js']); ?>
</head>
            ...
            <div class="card-body d-flex flex-column h-100 gap-3">
                ...
                <div class="auth-brand text-center text-lg-start">
                    <a href="index.html" class="logo-dark">
                        <span><img src="<?php echo e(Vite::asset('public/images/logo-dark.png')); ?>" alt="dark logo" height="22"></span>
                    </a>
                    <a href="index.html" class="logo-light">
                        <span><img src="<?php echo e(Vite::asset('public/images/logo-sm.png')); ?>" alt="logo" height="22"></span>
                    </a>
                </div>
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Back to <a href="<?php echo e(route('second', ['auth', 'login-2'])); ?>" class="text-muted ms-1"><b>Log In</b></a></p>
                </footer>
...
<?php /**PATH /home/denish/Desktop/Workspace/Internal/dk/attexlaravel/resources/views/auth/logout-2.blade.php ENDPATH**/ ?>