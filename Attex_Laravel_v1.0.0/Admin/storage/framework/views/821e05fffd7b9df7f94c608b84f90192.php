                ...
                <div class="col-xxl-4 col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-header py-4 text-center bg-primary">
                            <a href="<?php echo e(route('any', 'index')); ?>ml">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="<?php echo e(route('login')); ?>">
                                ...
                                <div class="mb-3">
                                    <a href="<?php echo e(route('second', ['auth', 'recoverpw'])); ?>" class="text-muted float-end fs-12">Forgot your password?</a>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-muted bg-body">Don't have an account? <a href="<?php echo e(route('second', ['auth', 'register'])); ?>" class="text-muted ms-1 link-offset-3 text-decoration-underline"><b>Sign Up</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
...
<?php /**PATH /home/denish/Desktop/Workspace/Internal/dk/attexlaravel/resources/views/auth/login.blade.php ENDPATH**/ ?>